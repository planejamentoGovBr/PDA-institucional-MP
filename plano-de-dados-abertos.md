...
Para atender a estratégia de abertura definida para este plano a /unidade de TIC utilizará no processo de publicação de dados automatização de atualização e implementação de APIs integradas.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MTQ3NDAyMDAsLTExMTIwNTU2MTMsMj
